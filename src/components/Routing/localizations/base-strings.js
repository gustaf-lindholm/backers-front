const baseStrings = {
  ...
  "home.pagetitle": "Backers Baker - Ekologiskt brödhantverk",
  ...
  "products.maincontent":
    "Backers bakar bröd, kaffebröd och specialprodukter för hand av ekologiskt mjöl. Vi använder ekologiska råvaror och undviker tillsatsämnen, till största möjliga mån.",
  "products.subcontent.one":
